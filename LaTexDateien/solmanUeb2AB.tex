...
\newenvironment{PartU}[1]
 {%
  ...
  \begin{flushright}
    \LARGE
    \textbf{
  Übungen\\ \bigskip  Band II\\ \bigskip Himmelsmechanik - Astrodynamik\\}
  \end{flushright}
  \vspace*{\fill}
  \clearpage
 }
...
\newenvironment{PartL}[1]
 {%
  ...
  \begin{flushright}
    \LARGE
    \textbf{Lösungsvorschläge \\ \bigskip Band II \\ \bigskip Himmelsmechanik - Astrodynamik\\}
  \end{flushright}
  \vspace*{\fill}
  \clearpage
 }
...
\begin{PartU}{Übungen - Band II Himmelsmechanik - Astrodynamik}
...
\begin{PartL}{Lösungsvorschläge - Band II Himmelsmechanik - Astrodynamik}
\newpage 
\thispagestyle{empty}
\quad 
\newpage
...
\quad 
\newpage
\input{hm/hm_formelsammlung}
\input{adyn/adyn_formelsammlung}
\newpage
