...
% v0 gegeneinander. In diesem Beispiel befindet sich der Scheitel des
% parabelförmigen Geschwindigkeitsprofils an der rechten Wand, die in der
% gewählten Darstellung die maximale Geschwindigkeit besitzt.
% -------------------------------------------------------------------------
...
subplot(1,3,2)
contour(ValY,ValZ,transpose(Omega),50,'linewidth',2, 'color', Colors(3,:));
grid on;
xlabel('{\itx}/m');
ylabel('{\ity}/m');
axis([0 maxY 0 maxZ])
